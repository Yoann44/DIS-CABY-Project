...
// dsPIC configuration bits for MPLAB
// These flags can either be specified in the source code (good practice) or through the MPLAB GUI (obsolete).
// A more detailed description of them can be found in the dsPIC30 family reference manual.
_FOSC(CSW_FSCM_OFF & XT_PLL8);		// Oscillator configuration
