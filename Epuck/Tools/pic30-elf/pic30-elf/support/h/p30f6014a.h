...
/*-------------------------------------------------------------------------
 *
 * MPLAB-C30  dsPIC30F6014A processor header
 *
...
extern volatile unsigned int SPI2STAT __attribute__((__near__));
extern volatile SPIxSTATBITS SPI2STATbits __attribute__((__near__));

/* SPI2CON: SPI2 Control Register */
extern volatile unsigned int SPI2CON __attribute__((__near__));
extern volatile SPIxCONBITS SPI2CONbits __attribute__((__near__));

/* SPI2BUF: SPI2 Buffer */
extern volatile unsigned int SPI2BUF __attribute__((__near__));
...
extern volatile unsigned int DCICON1 __attribute__((__near__));
...
extern volatile DCICON1BITS DCICON1bits __attribute__((__near__));

/* DCICON2: DCI Control Register 2 */
extern volatile unsigned int DCICON2 __attribute__((__near__));
...
extern volatile DCICON2BITS DCICON2bits __attribute__((__near__));

/* DCICON3: DCI Control Register 3 */
extern volatile unsigned int DCICON3 __attribute__((__near__));
typedef struct tagDCICON3BITS {
        unsigned BCG    :12;
        unsigned        :4;
} DCICON3BITS;
extern volatile DCICON3BITS DCICON3bits __attribute__((__near__));

/* DCISTAT: DCI Status Register */
extern volatile unsigned int DCISTAT __attribute__((__near__));
...
extern volatile DCISTATBITS DCISTATbits __attribute__((__near__));

/* TSCON: DCI Transmit Slot Enable Control Register */
extern volatile unsigned int TSCON __attribute__((__near__));
...
extern volatile TSCONBITS TSCONbits __attribute__((__near__));

/* RSCON: DCI Receive Slot Enable Control Register */
extern volatile unsigned int RSCON __attribute__((__near__));
...
extern volatile RSCONBITS RSCONbits __attribute__((__near__));

/* RXBUF0: DCI Receive Buffer 0 */
extern volatile unsigned int RXBUF0 __attribute__((__near__));

/* RXBUF1: DCI Receive Buffer 1 */
extern volatile unsigned int RXBUF1 __attribute__((__near__));

/* RXBUF2: DCI Receive Buffer 2 */
extern volatile unsigned int RXBUF2 __attribute__((__near__));

/* RXBUF3: DCI Receive Buffer 3 */
extern volatile unsigned int RXBUF3 __attribute__((__near__));

/* TXBUF0: DCI Transmit Buffer 0 */
extern volatile unsigned int TXBUF0 __attribute__((__near__));

/* TXBUF1: DCI Transmit Buffer 1 */
extern volatile unsigned int TXBUF1 __attribute__((__near__));

/* TXBUF2: DCI Transmit Buffer 2 */
extern volatile unsigned int TXBUF2 __attribute__((__near__));

/* TXBUF3: DCI Transmit Buffer 3 */
extern volatile unsigned int TXBUF3 __attribute__((__near__));
...
extern volatile unsigned int C1RX1SID __attribute__((__near__));
extern volatile CxRXxSIDBITS C1RX1SIDbits __attribute__((__near__));

/* C1RX1EID: CAN1 Receive 1 EID Register */
extern volatile unsigned int C1RX1EID __attribute__((__near__));

/* C1RX1DLC: CAN1 Receive 1 DLC Register */
extern volatile unsigned int C1RX1DLC __attribute__((__near__));
extern volatile CxRXxDLCBITS C1RX1DLCbits __attribute__((__near__));

/* C1RX1B1: CAN1 Receive 1 Buffer Word 1 */
extern volatile unsigned int C1RX1B1 __attribute__((__near__));

/* C1RX1B2: CAN1 Receive 1 Buffer Word 2 */
extern volatile unsigned int C1RX1B2 __attribute__((__near__));

/* C1RX1B3: CAN1 Receive 1 Buffer Word 3 */
extern volatile unsigned int C1RX1B3 __attribute__((__near__));

/* C1RX1B4: CAN1 Receive 1 Buffer Word 4 */
extern volatile unsigned int C1RX1B4 __attribute__((__near__));

/* C1RX1CON: CAN1 Receive 1 Control Register */
extern volatile unsigned int C1RX1CON __attribute__((__near__));
extern volatile CxRX1CONBITS C1RX1CONbits __attribute__((__near__));
...
extern volatile unsigned int C1RX0SID __attribute__((__near__));
extern volatile CxRXxSIDBITS C1RX0SIDbits __attribute__((__near__));

/* C1RX0EID: CAN1 Receive 0 EID Register */
extern volatile unsigned int C1RX0EID __attribute__((__near__));

/* C1RX0DLC: CAN1 Receive 0 DLC Register */
extern volatile unsigned int C1RX0DLC __attribute__((__near__));
extern volatile CxRXxDLCBITS C1RX0DLCbits __attribute__((__near__));

/* C1RX0B1: CAN1 Receive 0 Buffer Word 1 */
extern volatile unsigned int C1RX0B1 __attribute__((__near__));

/* C1RX0B2: CAN1 Receive 0 Buffer Word 2 */
extern volatile unsigned int C1RX0B2 __attribute__((__near__));

/* C1RX0B3: CAN1 Receive 0 Buffer Word 3 */
extern volatile unsigned int C1RX0B3 __attribute__((__near__));

/* C1RX0B4: CAN1 Receive 0 Buffer Word 4 */
extern volatile unsigned int C1RX0B4 __attribute__((__near__));

/* C1RX0CON: CAN1 Receive 0 Control Register */
extern volatile unsigned int C1RX0CON __attribute__((__near__));
extern volatile CxRX0CONBITS C1RX0CONbits __attribute__((__near__));

/* C1CTRL: CAN1 Control Register */
extern volatile unsigned int C1CTRL __attribute__((__near__));
...
extern volatile CxCTRLBITS C1CTRLbits __attribute__((__near__));

/* C1CFG1: CAN1 Baud Rate Control Register 1 */
extern volatile unsigned int C1CFG1 __attribute__((__near__));
typedef struct tagCxCFG1BITS {
        unsigned BRP    :6;
        unsigned SJW    :2;
        unsigned        :8;
} CxCFG1BITS;
extern volatile CxCFG1BITS C1CFG1bits __attribute__((__near__));

/* C1CFG2: CAN1 Baud Rate Control Register 2 */
extern volatile unsigned int C1CFG2 __attribute__((__near__));
...
extern volatile CxCFG2BITS C1CFG2bits __attribute__((__near__));

/* C1INTF: CAN1 Interrupt Flag Status Register */
extern volatile unsigned int C1INTF __attribute__((__near__));
...
extern volatile CxINTFBITS C1INTFbits __attribute__((__near__));

/* C1INTE: CAN1 Interrupt Enable Control Register */
extern volatile unsigned int C1INTE __attribute__((__near__));
...
extern volatile CxINTEBITS C1INTEbits __attribute__((__near__));

/* C1EC: CAN1 Error Count Register */
extern volatile unsigned int C1EC __attribute__((__near__));

/* C1RERRCNT: CAN1 Receive Error Count (C1EC low byte) */
extern volatile unsigned char C1RERRCNT __attribute__((__near__));

/* C1TERRCNT: CAN1 Transmit Error Count (C1EC high byte) */
extern volatile unsigned char C1TERRCNT __attribute__((__near__));
...
extern volatile unsigned int C2RXF0SID __attribute__((__near__));
extern volatile CxRXFxSIDBITS C2RXF0SIDbits __attribute__((__near__));
extern volatile unsigned int C2RXF0EIDH __attribute__((__near__));
extern volatile unsigned int C2RXF0EIDL __attribute__((__near__));

extern volatile unsigned int C2RXF1SID __attribute__((__near__));
extern volatile CxRXFxSIDBITS C2RXF1SIDbits __attribute__((__near__));
extern volatile unsigned int C2RXF1EIDH __attribute__((__near__));
extern volatile unsigned int C2RXF1EIDL __attribute__((__near__));

extern volatile unsigned int C2RXF2SID __attribute__((__near__));
extern volatile CxRXFxSIDBITS C2RXF2SIDbits __attribute__((__near__));
extern volatile unsigned int C2RXF2EIDH __attribute__((__near__));
extern volatile unsigned int C2RXF2EIDL __attribute__((__near__));

extern volatile unsigned int C2RXF3SID __attribute__((__near__));
extern volatile CxRXFxSIDBITS C2RXF3SIDbits __attribute__((__near__));
extern volatile unsigned int C2RXF3EIDH __attribute__((__near__));
extern volatile unsigned int C2RXF3EIDL __attribute__((__near__));

extern volatile unsigned int C2RXF4SID __attribute__((__near__));
extern volatile CxRXFxSIDBITS C2RXF4SIDbits __attribute__((__near__));
extern volatile unsigned int C2RXF4EIDH __attribute__((__near__));
extern volatile unsigned int C2RXF4EIDL __attribute__((__near__));

extern volatile unsigned int C2RXF5SID __attribute__((__near__));
extern volatile CxRXFxSIDBITS C2RXF5SIDbits __attribute__((__near__));
extern volatile unsigned int C2RXF5EIDH __attribute__((__near__)); 
extern volatile unsigned int C2RXF5EIDL __attribute__((__near__));
 
extern volatile unsigned int C2RXM0SID __attribute__((__near__));
extern volatile CxRXMxSIDBITS C2RXM0SIDbits __attribute__((__near__));
extern volatile unsigned int C2RXM0EIDH __attribute__((__near__));
extern volatile unsigned int C2RXM0EIDL __attribute__((__near__));

extern volatile unsigned int C2RXM1SID __attribute__((__near__));
extern volatile CxRXMxSIDBITS C2RXM1SIDbits __attribute__((__near__));
extern volatile unsigned int C2RXM1EIDH __attribute__((__near__));
extern volatile unsigned int C2RXM1EIDL __attribute__((__near__));

extern volatile unsigned int C2TX2SID __attribute__((__near__));
extern volatile CxTXxSIDBITS C2TX2SIDbits __attribute__((__near__));
extern volatile unsigned int C2TX2EID __attribute__((__near__));
extern volatile CxTXxEIDBITS C2TX2EIDbits __attribute__((__near__));
extern volatile unsigned int C2TX2DLC __attribute__((__near__));
extern volatile CxTXxDLCBITS C2TX2DLCbits __attribute__((__near__));
extern volatile unsigned int C2TX2B1 __attribute__((__near__));
extern volatile unsigned int C2TX2B2 __attribute__((__near__));
extern volatile unsigned int C2TX2B3 __attribute__((__near__));
extern volatile unsigned int C2TX2B4 __attribute__((__near__));
extern volatile unsigned int C2TX2CON __attribute__((__near__));
extern volatile CxTXxCONBITS C2TX2CONbits __attribute__((__near__));

extern volatile unsigned int C2TX1SID __attribute__((__near__));
extern volatile CxTXxSIDBITS C2TX1SIDbits __attribute__((__near__));
extern volatile unsigned int C2TX1EID __attribute__((__near__));
extern volatile CxTXxEIDBITS C2TX1EIDbits __attribute__((__near__));
extern volatile unsigned int C2TX1DLC __attribute__((__near__));
extern volatile CxTXxDLCBITS C2TX1DLCbits __attribute__((__near__));
extern volatile unsigned int C2TX1B1 __attribute__((__near__));
extern volatile unsigned int C2TX1B2 __attribute__((__near__));
extern volatile unsigned int C2TX1B3 __attribute__((__near__));
extern volatile unsigned int C2TX1B4 __attribute__((__near__));
extern volatile unsigned int C2TX1CON __attribute__((__near__));
extern volatile CxTXxCONBITS C2TX1CONbits __attribute__((__near__));

extern volatile unsigned int C2TX0SID __attribute__((__near__));
extern volatile CxTXxSIDBITS C2TX0SIDbits __attribute__((__near__));
extern volatile unsigned int C2TX0EID __attribute__((__near__));
extern volatile CxTXxEIDBITS C2TX0EIDbits __attribute__((__near__));
extern volatile unsigned int C2TX0DLC __attribute__((__near__));
extern volatile CxTXxDLCBITS C2TX0DLCbits __attribute__((__near__));
extern volatile unsigned int C2TX0B1 __attribute__((__near__));
extern volatile unsigned int C2TX0B2 __attribute__((__near__));
extern volatile unsigned int C2TX0B3 __attribute__((__near__));
extern volatile unsigned int C2TX0B4 __attribute__((__near__));
extern volatile unsigned int C2TX0CON __attribute__((__near__));
extern volatile CxTXxCONBITS C2TX0CONbits __attribute__((__near__));

extern volatile unsigned int C2RX1SID __attribute__((__near__));
extern volatile CxRXxSIDBITS C2RX1SIDbits __attribute__((__near__));
extern volatile unsigned int C2RX1EID __attribute__((__near__));
extern volatile unsigned int C2RX1DLC __attribute__((__near__));
extern volatile CxRXxDLCBITS C2RX1DLCbits __attribute__((__near__));
extern volatile unsigned int C2RX1B1 __attribute__((__near__));
extern volatile unsigned int C2RX1B2 __attribute__((__near__));
extern volatile unsigned int C2RX1B3 __attribute__((__near__));
extern volatile unsigned int C2RX1B4 __attribute__((__near__));
extern volatile unsigned int C2RX1CON __attribute__((__near__));
extern volatile CxRX1CONBITS C2RX1CONbits __attribute__((__near__));

extern volatile unsigned int C2RX0SID __attribute__((__near__));
extern volatile CxRXxSIDBITS C2RX0SIDbits __attribute__((__near__));
extern volatile unsigned int C2RX0EID __attribute__((__near__));
extern volatile unsigned int C2RX0DLC __attribute__((__near__));
extern volatile CxRXxDLCBITS C2RX0DLCbits __attribute__((__near__));
extern volatile unsigned int C2RX0B1 __attribute__((__near__));
extern volatile unsigned int C2RX0B2 __attribute__((__near__));
extern volatile unsigned int C2RX0B3 __attribute__((__near__));
extern volatile unsigned int C2RX0B4 __attribute__((__near__));
extern volatile unsigned int C2RX0CON __attribute__((__near__));
extern volatile CxRX0CONBITS C2RX0CONbits __attribute__((__near__));

extern volatile unsigned int C2CTRL __attribute__((__near__));
extern volatile CxCTRLBITS C2CTRLbits __attribute__((__near__));

extern volatile unsigned int C2CFG1 __attribute__((__near__));
extern volatile CxCFG1BITS C2CFG1bits __attribute__((__near__));

extern volatile unsigned int C2CFG2 __attribute__((__near__));
extern volatile CxCFG2BITS C2CFG2bits __attribute__((__near__));

extern volatile unsigned int C2INTF __attribute__((__near__));
extern volatile CxINTFBITS C2INTFbits __attribute__((__near__));

extern volatile unsigned int C2INTE __attribute__((__near__));
extern volatile CxINTEBITS C2INTEbits __attribute__((__near__));

extern volatile unsigned int C2EC __attribute__((__near__));
extern volatile unsigned char C2RERRCNT __attribute__((__near__));
extern volatile unsigned char C2TERRCNT __attribute__((__near__));
